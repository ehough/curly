...
class ehough_curly_UrlTest extends PHPUnit_Framework_TestCase {
	...
	*/
	...
	private function _testConstructValidIpv6($ip)
	{
        ...
        $url = new ehough_curly_Url("http://[$ip]:89/foo/bar?fickle#niner/eight");
    ...
    function test__toString()
    {
        ...
        $this->assertEquals('http://user@tubepress.org:994/something/index.php?one=two+four&three=five&nine=ten#fragment/one/three?poo', "$out");
    }

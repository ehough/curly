...
class ehough_curly_Url
{
     ...
     *
     * @throws InvalidArgumentException If an invalid URL is supplied.
     */
     ...
     *
     * @throws InvalidArgumentException If the provided scheme is not a string or is malformed.
     *
     * @return void
     */
    public function setScheme($scheme)
    {
        if (! is_string($scheme)) {
            ...
            throw new InvalidArgumentException("Scheme must be a string ($scheme)");
        }
        ...
        if (preg_match_all('`^' . self::$_regexScheme . '$`', $scheme, $matches) !== 1) {
            ...
            throw new InvalidArgumentException('Scheme names consist of a sequence of characters beginning with a'
     ...
     *
     * @throws InvalidArgumentException If the supplied username is in invalid syntax.
     *
     * @return void
     */
    public function setUser($user)
    {
        ...
        if (preg_match_all($regex, $user, $matches) !== 1) {
            ...
            throw new InvalidArgumentException('User must match ' . $regex);
        }
     ...
     *
     * @throws InvalidArgumentException If the supplied hostname is invalid.
     *
     * @return void
     */
    ...
    public function setHostIpv4($host)
    {
        if (! self::_isIpv4Address($host)) {
            ...
            throw new InvalidArgumentException("Invalid IPv4 ($host)");
        }
    ...
    public function setHostIpv6($host)
    {
        if (! self::_isIpv6Address($host)) {
            ...
            throw new InvalidArgumentException("Invalid IPv6 ($host)");
        }
    ...
    public function setPort($port)
    {
        if (! is_numeric($port)) {
            ...
            throw new InvalidArgumentException("Port must be numeric ($port)");
        }
        ...
        if (! is_int($intPort) || $intPort < 1) {
            ...
            throw new InvalidArgumentException("Port must be a positive integer ($port)");
        }
    ...
    public function setPath($path)
    {
        ...
        if (! is_string($path)) {
            ...
            throw new InvalidArgumentException("Path must be a string ($path)");
        }
    ...
    public function setQuery($query)
    {
        if (! is_string($query)) {
            ...
            throw new InvalidArgumentException("Query must be a string ($query)");
        }
    ...
    public function setFragment($fragment)
    {
        if (! is_string($fragment)) {
            ...
            throw new InvalidArgumentException("Fragment must be a string ($fragment)");
        }
    ...
    public function setQueryVariables($array)
    {
        if (! is_array($array)) {
            ...
            throw new InvalidArgumentException('Must pass an array to setQueryVariables()');
        }
